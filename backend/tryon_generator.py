...
class IDMVTONService:
    ...
    def _upload_image(self, image_path: str) -> str:
        ...
        """
        # Use Cloudinary instead of imgbb (more reliable)
        try:
            import cloudinary.uploader
            import uuid
            
            # Generate unique public_id
            public_id = f"temp/fal_{uuid.uuid4().hex[:8]}"
    ...
    def _call_vton_api(
        ...
        payload = {
            ...
            "category": category,
            "description": "Fashionable clothing item for virtual try-on"  # Required by FAL.AI
        }
